              ...
              <div className="flex w-full justify-between flex-col-reverse items-center md:flex-row gap-4">
                ...
                <div className="flex gap-4 flex-col md:flex-row  w-full md:w-fit  ">
                  <Select value={sort} onValueChange={handleSortChange}>
                    <SelectTrigger className="w-full py-5 md:w-[150px] border-gray-200 shadow-xs text-sm hover:shadow-sm transition-all rounded-sm bg-white z-5 cursor-pointer ">
                  ...
                  >
                    <SelectTrigger className="w-full py-5  min-w-[150px] bg-white z-5   border-gray-200 shadow-xs text-sm rounded-sm hover:shadow-sm transition-all cursor-pointer">
