            ...
            <tr>
              <td style="padding: 0 40px 40px 40px;">
                ...
                <div style="text-align: center; margin: 0 0 32px 0;">
                  <a href="http://localhost:3000/" style="display: inline-block; background: #000000; color: #ffffff; text-decoration: none; padding: 16px 48px; border-radius: 8px; font-weight: 600; font-size: 15px; letter-spacing: 0.3px;">
