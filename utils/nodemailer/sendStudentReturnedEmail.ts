...
export async function sendStudentReturnedEmail({
  to,
  adviserName,
  thesisTitle,
  thesisAbstract,
  ...
  const subject = "Thesis Request Returned - Archivia";
            ...
            <tr>
              <td style="padding: 35px;">
                <div style="display: inline-block; background: #ffffff; border: 2px solid #000000; border-radius: 6px; padding: 6px 16px;">
                  <span style="color: #000000; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px;">Request Returned</span>
                </div>
              </td>
            </tr>
          ...
          <tr>
            <td style="padding: 0 40px 40px 40px;">
              <p style="font-size:16px;margin:0 0 16px 0;">
                <strong>${adviserName}</strong> has returned your thesis request.
              </p>
             ...
             <div style="background: #fafafa; border: 1px solid #e5e5e5; border-radius: 8px; padding: 24px; margin-bottom: 24px;">
              ...
              <div style="background:#fafafa;border:1px solid #e5e5e5;border-radius:8px;padding:20px;margin-bottom:24px; ">
                <p style="color:#000;font-size:13px;font-weight:600;text-transform:uppercase;margin:0 0 12px 0;">Feedback</p>
