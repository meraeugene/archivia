...
interface SendRequestAdviserEmailOptions {
  to: string;
  studentName: string;
  thesisTitle: string;
...
/**
 * Sends an email notification to an adviser when a student sends a thesis request.
 * Black & white minimalist Archivia style.
 */
export async function sendRequestAdviserEmail({
  to,
  studentName,
  thesisTitle,
  thesisAbstract,
           ...
           <!-- Header -->
            ...
            <tr>
              <td style="padding: 35px;">
                <div style="display: inline-block; background: #ffffff; border: 2px solid #000000; border-radius: 6px; padding: 6px 16px;">
                  <span style="color: #000000; font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px;">New Request</span>
                </div>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding: 0 40px 40px 40px;">
                <h2 style="color: #000000; margin: 0 0 24px 0; font-size: 26px; font-weight: 700; line-height: 1.2;">You’ve received a new advisory request</h2>

                <p style="color: #171717; font-size: 16px; line-height: 1.6; margin: 0 0 24px 0;">
                  <strong>${studentName}</strong> has sent you a request to be their thesis adviser.
                </p>
                ...
                <div style="text-align: center; margin: 0 0 32px 0;">
                  <a href="https://archivia-official.vercel.app/faculty/advisory-requests" style="display: inline-block; background: #000000; color: #ffffff; text-decoration: none; padding: 16px 48px; border-radius: 8px; font-weight: 600; font-size: 15px; letter-spacing: 0.3px;">
