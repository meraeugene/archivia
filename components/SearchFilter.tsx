      ...
      <div className="max-w-5xl mx-auto px-4 md:px-6">
        <div className="relative max-w-4xl mx-auto">
          <input
            ...
            className="w-full pl-10 pr-12 py-3 md:text-base shadow-sm  
              text-sm bg-white focus:shadow-md hover:shadow-md focus:outline-none transition-colors rounded-sm"
          />
